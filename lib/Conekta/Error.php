...
{
	public function __construct($message=null, $message_to_purchaser=null, $type=null, $http_code=null, $code=null, $params=null) {
	...
	public static function errorHandler($resp, $http_code) {
		...
		switch ($http_code) {
			case 400:
				throw new Conekta_MalformedRequestError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			case 401:
				throw new Conekta_AuthenticationError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			case 402:
				throw new Conekta_ProcessingError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			case 404:
				throw new Conekta_ResourceNotFoundError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			case 422:
				throw new Conekta_ParameterValidationError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			case 500:
				throw new Conekta_ApiError($message, $message_to_purchaser, $type, $http_code, $code, $params);
			default:
				throw new Conekta_Error($message, $message_to_purchaser, $type, $http_code, $code, $params);
		}
	}
}
